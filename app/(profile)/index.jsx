    ...
    <View className="h-full p-3 bg-black">
      ...
      <View>
        <View className="mt-5 items-center">
          <View className="flex flex-row justify-between items-center w-full px-4 py-3">
            <BackButton />
            <Button handlePress={() => router.push("/ep")}>
              <View className="flex flex-row items-center space-x-2 bg-[#1c1c1c] px-4 py-2 rounded-full">
